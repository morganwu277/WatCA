...
echo
echo Wrote Cassandra public and private IP addresses to servers_public and servers_public_private
cat servers_public_private


echo Wrote YCSB public and private IP addresses to servers_public_ycsb and servers_public_private_ycsb
cat servers_public_private_ycsb
